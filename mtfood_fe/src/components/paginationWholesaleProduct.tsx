...
import ProductWholesaleCard from "../features/product/components/productWholesaleCard";
...
export default function PaginationWholesaleProducts({
    products,
    totalPage,
    isLoading,
    searchParams,
