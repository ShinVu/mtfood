...
import PaginationWholesaleProducts from "../components/paginationWholesaleProduct.js";
...
export default function ProductWholesale() {
    const { t } = useTranslation();
